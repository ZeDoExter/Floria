...
export class CatalogService {
  ...
  async searchProducts(q: string) {
    ...
    return this.productRepository.createQueryBuilder('product')
      ...
      .where(`to_tsvector('english', product.name || ' ' || coalesce(product.description, '')) @@ plainto_tsquery('english', :q)`, { q })
      .orWhere('product.name ILIKE :likeQ', { likeQ: `%${q}%` })
      .orWhere('product.description ILIKE :likeQ', { likeQ: `%${q}%` })
