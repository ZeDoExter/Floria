...
export const CheckoutPage = () => {
  ...
  if (!user) {
    return (
      <main className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="bg-card border-2 border-border rounded-3xl p-10 text-center max-w-sm w-full shadow-card animate-fade-in">
  ...
  if (!canPlaceOrders(user.role)) {
    return (
      <main className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="bg-card border-2 border-border rounded-3xl p-10 text-center max-w-sm w-full shadow-card">
          <span className="text-4xl mb-4 block">🌻</span>
    ...
    return (
      <main className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="text-center animate-fade-in">
          <span className="text-5xl mb-4 block animate-pulse-soft">💳</span>
    ...
    <main className="min-h-screen bg-background px-4 py-8 md:py-12">
      <div className="mx-auto max-w-2xl animate-fade-in-up">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold font-heading text-foreground mt-3">
            Checkout 🌷
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Order Items */}
          <div className="rounded-3xl bg-card border-2 border-border shadow-card p-5 space-y-3">
            <h2 className="font-bold text-foreground text-sm uppercase tracking-wide text-muted-foreground">Order Summary</h2>
          ...
          {/* Delivery Info */}
          <div className="rounded-3xl bg-card border-2 border-border shadow-card p-5 space-y-4">
            <h2 className="font-bold text-foreground text-sm uppercase tracking-wide text-muted-foreground">Delivery Details</h2>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border-2 border-border rounded-xl bg-background text-foreground text-sm focus:outline-none focus:border-primary transition-colors"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 border-2 border-border rounded-xl bg-background text-foreground text-sm focus:outline-none focus:border-primary resize-none transition-colors"
                rows={3}
              />
            </div>
          </div>
          ...
          {error && (
            <div className="bg-error/10 border-2 border-error/20 rounded-2xl p-4 animate-fade-in">
          ...
          <button
            type="submit"
            className="w-full py-4 rounded-2xl font-bold text-base bg-primary text-primary-foreground hover:bg-secondary transition-all duration-200 shadow-soft hover:shadow-soft-lg flex items-center justify-center gap-3"
          >
            <span>💳</span>
